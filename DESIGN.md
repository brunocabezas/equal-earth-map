...
### Navigation
Night bar, cream brand serif, thin-line globe mark, Mercator size menu before the ice search well, then labeled Layers and About pills. On ≤1100px the tagline hides and Mercator shortens to the word Mercator. On ≤720px search hides so the bar stays one row. Centering stays on the map. Wall-map downloads live in About as ice pills.
