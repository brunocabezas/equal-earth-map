...
const EN: AtlasMessages = {
  ...
  legendLead: "Filled countries are true size. Coral stripes are how they look on Mercator.",
  legendLeadCompact: "Filled land is true size. Stripes are Mercator.",
  legendRestoreStatus: "True size only.",
  legendRestoreAction: "Show Mercator stripes",
  attribFull: "Equal Earth projection by Šavrič, Patterson & Jenny · Wall maps by Tom Patterson / BMZ · Vectors from Natural Earth",
  attribCredit: "Natural Earth",
  close: "Close",
  ...
  aboutP6: "Filled countries are true size. Coral stripes show how large they look on Mercator. Click a country for the numbers.",
  ...
  compactOutline: "The stripes are how large this looks on Mercator.",
  equatorNoOutline: "Near the equator the two projections agree closely on size, so there are no extra stripes.",
  ...
  stageAriaAlways: "Equal Earth map with Mercator size stripes. Arrow keys pan, Enter selects the country in the center, plus and minus zoom, Escape clears the selection or leaves the map.",
  stageAriaTap: "Equal Earth map. Tap a country for Mercator size. Arrow keys pan, Enter selects the country in the center, plus and minus zoom, Escape clears the selection or leaves the map.",
  stageAriaHover: "Equal Earth map. Hover a country for Mercator size. Arrow keys pan, Enter selects the country in the center, plus and minus zoom, Escape clears the selection or leaves the map.",
  stageAriaPlain: "Equal Earth world map. Arrow keys pan, Enter selects the country in the center, plus and minus zoom, Escape clears the selection or leaves the map.",
  stageCenterCountry: "{name} is in the center. Press Enter to select it.",
...
const ES: AtlasMessages = {
  ...
  mercatorCompact: "Mercator",
  mercatorOff: "Sin franjas",
  mercatorOffShort: "Sin franjas",
  mercatorOffCompact: "Ocultas",
  mercatorMenu: "Cuándo mostrar la distorsión Mercator",
  mercatorAria: "Cómo Mercator distorsiona los países",
  mercatorAriaHidden: "Cómo Mercator distorsiona los países (franjas ocultas)",
  compareAlways: "Todos los países",
  compareHover: "Cuando señalo",
  compareTap: "Cuando pulso",
  compareHide: "Ocultar comparación",
  hintAlways: "Las franjas coral muestran lo grandes que se ven los países en Mercator.",
  ...
  hintOff: "Solo Equal Earth. Las franjas Mercator están ocultas.",
  search: "Buscar",
  ...
  countriesAlwaysOn: "Siempre visible",
  about: "Acerca de",
  ...
  legendMercatorShort: "Mercator",
  legendLead: "Los países rellenos son el tamaño real. Las franjas coral son cómo se ven en Mercator.",
  legendLeadCompact: "La tierra rellena es tamaño real. Las franjas son Mercator.",
  legendRestoreStatus: "Solo tamaño real.",
  legendRestoreAction: "Mostrar franjas Mercator",
  ...
  aboutP6: "Los países rellenos son el tamaño real. Las franjas coral muestran lo grandes que se ven en Mercator. Haz clic en un país para ver las cifras.",
  ...
  compactOutline: "Las franjas son lo grande que se ve en Mercator.",
  equatorNoOutline: "Cerca del ecuador las dos proyecciones coinciden en el tamaño, así que no hay franjas extra.",
  ...
  popThousand: "{n} mil",
  stageAriaAlways: "Mapa Equal Earth con franjas de tamaño Mercator. Las flechas desplazan, Intro selecciona el país del centro, más y menos acercan, Escape quita la selección o sale del mapa.",
  stageAriaTap: "Mapa Equal Earth. Pulsa un país para el tamaño Mercator. Las flechas desplazan, Intro selecciona el país del centro, más y menos acercan, Escape quita la selección o sale del mapa.",
  stageAriaHover: "Mapa Equal Earth. Señala un país para el tamaño Mercator. Las flechas desplazan, Intro selecciona el país del centro, más y menos acercan, Escape quita la selección o sale del mapa.",
  stageAriaPlain: "Mapa mundial Equal Earth. Las flechas desplazan, Intro selecciona el país del centro, más y menos acercan, Escape quita la selección o sale del mapa.",
  stageCenterCountry: "{name} está en el centro. Pulsa Intro para seleccionarlo.",
...
const FR: AtlasMessages = {
  ...
  mercatorCompact: "Mercator",
  mercatorOff: "Sans hachures",
  mercatorOffShort: "Sans hachures",
  mercatorOffCompact: "Masqué",
  mercatorMenu: "Quand montrer l’étirement Mercator",
  mercatorAria: "Comment Mercator étire les pays",
  mercatorAriaHidden: "Comment Mercator étire les pays (hachures masquées)",
  compareAlways: "Tous les pays",
  compareHover: "Quand je pointe",
  compareTap: "Quand je tape",
  compareHide: "Masquer la comparaison",
  hintAlways: "Les hachures corail montrent la taille apparente des pays sur Mercator.",
  ...
  hintOff: "Equal Earth seulement. Les hachures Mercator sont masquées.",
  search: "Rechercher",
  ...
  countriesAlwaysOn: "Toujours affiché",
  about: "À propos",
  ...
  legendMercatorShort: "Mercator",
  legendLead: "Les pays colorés sont à taille réelle. Les hachures corail sont leur apparence sur Mercator.",
  legendLeadCompact: "Les terres colorées sont à taille réelle. Les hachures sont Mercator.",
  legendRestoreStatus: "Taille réelle seulement.",
  legendRestoreAction: "Afficher les hachures Mercator",
  ...
  aboutP6: "Les pays colorés sont à taille réelle. Les hachures corail montrent leur taille apparente sur Mercator. Cliquez un pays pour les chiffres.",
  ...
  compactOutline: "Les hachures sont la taille apparente sur Mercator.",
  equatorNoOutline: "Près de l’équateur, les deux projections s’accordent sur la taille, donc il n’y a pas de hachures supplémentaires.",
  ...
  popThousand: "{n} mille",
  stageAriaAlways: "Carte Equal Earth avec hachures de taille Mercator. Les flèches déplacent, Entrée sélectionne le pays au centre, plus et moins zooment, Échap efface la sélection ou quitte la carte.",
  stageAriaTap: "Carte Equal Earth. Touchez un pays pour la taille Mercator. Les flèches déplacent, Entrée sélectionne le pays au centre, plus et moins zooment, Échap efface la sélection ou quitte la carte.",
  stageAriaHover: "Carte Equal Earth. Survolez un pays pour la taille Mercator. Les flèches déplacent, Entrée sélectionne le pays au centre, plus et moins zooment, Échap efface la sélection ou quitte la carte.",
  stageAriaPlain: "Carte mondiale Equal Earth. Les flèches déplacent, Entrée sélectionne le pays au centre, plus et moins zooment, Échap efface la sélection ou quitte la carte.",
  stageCenterCountry: "{name} est au centre. Appuyez sur Entrée pour le sélectionner.",
...
const PT: AtlasMessages = {
  ...
  hintOff: "Só Equal Earth. As listras Mercator estão ocultas.",
  search: "Buscar",
  ...
  countriesAlwaysOn: "Sempre visível",
  about: "Sobre",
  ...
  legendMercatorShort: "Mercator",
  legendLead: "Países preenchidos estão em tamanho real. As listras coral são como aparecem no Mercator.",
  legendLeadCompact: "A terra preenchida é tamanho real. As listras são Mercator.",
  legendRestoreStatus: "Somente tamanho real.",
  legendRestoreAction: "Mostrar listras Mercator",
  ...
  aboutP6: "Os países preenchidos são o tamanho real. As listras coral mostram o tamanho aparente no Mercator. Clique em um país para ver os números.",
  ...
  compactOutline: "As listras são o tamanho aparente no Mercator.",
  equatorNoOutline: "Perto do equador as duas projeções concordam no tamanho, então não há listras extra.",
  ...
  popThousand: "{n} mil",
  stageAriaAlways: "Mapa Equal Earth com contornos de tamanho Mercator. As setas deslocam, Enter seleciona o país no centro, mais e menos aproximam, Escape limpa a seleção ou sai do mapa.",
  stageAriaTap: "Mapa Equal Earth. Toque em um país para o tamanho Mercator. As setas deslocam, Enter seleciona o país no centro, mais e menos aproximam, Escape limpa a seleção ou sai do mapa.",
  stageAriaHover: "Mapa Equal Earth. Aponte para um país para o tamanho Mercator. As setas deslocam, Enter seleciona o país no centro, mais e menos aproximam, Escape limpa a seleção ou sai do mapa.",
  stageAriaPlain: "Mapa mundial Equal Earth. As setas deslocam, Enter seleciona o país no centro, mais e menos aproximam, Escape limpa a seleção ou sai do mapa.",
  stageCenterCountry: "{name} está no centro. Pressione Enter para selecionar.",
  searchKindCountry: "País",
  faq: [
    {
...
const AR: AtlasMessages = {
  ...
  legendLead: "البلدان المملوءة بحجمها الحقيقي. الخطوط المرجانية هي شكلها على مركاتور.",
  legendLeadCompact: "الأرض المملوءة بالحجم الحقيقي. الخطوط المرجانية مركاتور.",
  ...
  aboutP6: "البلدان المعبأة بالحجم الحقيقي. الخطوط المرجانية تُظهر حجمها الظاهر على مركاتور. انقر دولة لرؤية الأرقام.",
  ...
  compactOutline: "الخطوط المرجانية هي حجمها الظاهري على مركاتور.",
  equatorNoOutline: "قرب خط الاستواء يتفق المسقطان على الحجم، لذلك لا توجد خطوط إضافية.",
  ...
  popMillion: "{n} مليون",
  popThousand: "{n} ألف",
  stageAriaAlways: "خريطة Equal Earth مع خطوط حجم مركاتور. الأسهم تحرّك، Enter يختار الدولة في الوسط، زائد وناقص للتكبير، Escape يلغي التحديد أو يغادر الخريطة.",
  stageAriaTap: "خريطة Equal Earth. انقر دولة لحجم مركاتور. الأسهم تحرّك، Enter يختار الدولة في الوسط، زائد وناقص للتكبير، Escape يلغي التحديد أو يغادر الخريطة.",
  stageAriaHover: "خريطة Equal Earth. مرّر على دولة لحجم مركاتور. الأسهم تحرّك، Enter يختار الدولة في الوسط، زائد وناقص للتكبير، Escape يلغي التحديد أو يغادر الخريطة.",
  stageAriaPlain: "خريطة العالم Equal Earth. الأسهم تحرّك، Enter يختار الدولة في الوسط، زائد وناقص للتكبير، Escape يلغي التحديد أو يغادر الخريطة.",
  stageCenterCountry: "{name} في الوسط. اضغط Enter لاختياره.",
...
const ZH: AtlasMessages = {
  ...
  mercatorCompact: "墨卡托",
  mercatorOff: "条纹已关",
  mercatorOffShort: "条纹已关",
  mercatorOffCompact: "已关",
  mercatorMenu: "何时显示墨卡托拉伸",
  mercatorAria: "墨卡托如何拉伸国家",
  mercatorAriaHidden: "墨卡托如何拉伸国家（条纹已隐藏）",
  compareAlways: "每个国家",
  compareHover: "当我指向时",
  compareTap: "当我点按时",
  compareHide: "隐藏对照",
  hintAlways: "珊瑚色条纹显示各国在墨卡托上显得有多大。",
  hintHover: "指向一个国家即可看到其墨卡托表观大小。",
  hintTap: "点按一个国家即可看到其墨卡托表观大小。",
  hintOff: "仅 Equal Earth。墨卡托条纹已隐藏。",
  search: "搜索",
  ...
  legendLead: "填色国家是真实面积。珊瑚色条纹是它们在墨卡托上的样子。",
  legendLeadCompact: "填色陆地是真实面积。条纹是墨卡托。",
  legendRestoreStatus: "仅真实面积。",
  legendRestoreAction: "显示墨卡托条纹",
  ...
  aboutP6: "填色国家是真实面积。珊瑚色条纹显示它们在墨卡托上显得有多大。点击国家可看数字。",
  ...
  compactOutline: "条纹是它在墨卡托上看起来有多大。",
  equatorNoOutline: "靠近赤道时两种投影的面积接近，因此没有额外条纹。",
  ...
  popMillion: "{n} 百万",
  popThousand: "{n} 千",
  stageAriaAlways: "带墨卡托大小轮廓的 Equal Earth 地图。方向键平移，Enter 选择中心国家，加减号缩放，Escape 清除选择或离开地图。",
  stageAriaTap: "Equal Earth 地图。点按国家查看墨卡托大小。方向键平移，Enter 选择中心国家，加减号缩放，Escape 清除选择或离开地图。",
  stageAriaHover: "Equal Earth 地图。悬停国家查看墨卡托大小。方向键平移，Enter 选择中心国家，加减号缩放，Escape 清除选择或离开地图。",
  stageAriaPlain: "Equal Earth 世界地图。方向键平移，Enter 选择中心国家，加减号缩放，Escape 清除选择或离开地图。",
  stageCenterCountry: "{name} 在中心。按 Enter 选择。",
...
const RU: AtlasMessages = {
  ...
  mercatorCompact: "Меркатор",
  mercatorOff: "Без штриховки",
  mercatorOffShort: "Без штриховки",
  mercatorOffCompact: "Выкл",
  mercatorMenu: "Когда показывать растяжение Меркатора",
  mercatorAria: "Как Меркатор растягивает страны",
  mercatorAriaHidden: "Как Меркатор растягивает страны (штриховка скрыта)",
  compareAlways: "Каждая страна",
  compareHover: "Когда навожу",
  compareTap: "Когда нажимаю",
  compareHide: "Скрыть сравнение",
  hintAlways: "Коралловая штриховка показывает, насколько большими страны выглядят на Меркаторе.",
  ...
  hintOff: "Только Equal Earth. Штриховка Меркатора скрыта.",
  search: "Поиск",
  ...
  countriesAlwaysOn: "Всегда включено",
  about: "О проекте",
  ...
  legendLead: "Заливка стран — истинный размер. Коралловая штриховка — как на Меркаторе.",
  legendLeadCompact: "Заливка суши — истинный размер. Штриховка — Меркатор.",
  legendRestoreStatus: "Только истинный размер.",
  legendRestoreAction: "Показать штриховку Меркатора",
  ...
  aboutP6: "Заливка стран — истинный размер. Коралловая штриховка показывает, насколько крупными они выглядят на Меркаторе. Нажмите страну, чтобы увидеть числа.",
  ...
  compactOutline: "Штриховка — насколько большой она выглядит на Меркаторе.",
  equatorNoOutline: "У экватора проекции близко сходятся по размеру, поэтому дополнительной штриховки нет.",
  ...
  popMillion: "{n} млн",
  popThousand: "{n} тыс.",
  stageAriaAlways: "Карта Equal Earth с контурами размера Меркатора. Стрелки двигают, Enter выбирает страну в центре, плюс и минус масштабируют, Escape снимает выбор или покидает карту.",
  stageAriaTap: "Карта Equal Earth. Нажмите страну для размера Меркатора. Стрелки двигают, Enter выбирает страну в центре, плюс и минус масштабируют, Escape снимает выбор или покидает карту.",
  stageAriaHover: "Карта Equal Earth. Наведите на страну для размера Меркатора. Стрелки двигают, Enter выбирает страну в центре, плюс и минус масштабируют, Escape снимает выбор или покидает карту.",
  stageAriaPlain: "Карта мира Equal Earth. Стрелки двигают, Enter выбирает страну в центре, плюс и минус масштабируют, Escape снимает выбор или покидает карту.",
  stageCenterCountry: "{name} в центре. Нажмите Enter, чтобы выбрать.",
