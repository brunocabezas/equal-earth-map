...
const EN: AtlasMessages = {
  ...
  mercatorSize: "Mercator size",
  mercatorShort: "Mercator",
  mercatorMenu: "When to show Mercator size",
  compareAlways: "Always",
  compareHover: "On hover",
  compareTap: "On tap",
  ...
  searchEmpty: "No places match “{query}”",
  layers: "Layers",
...
const ES: AtlasMessages = {
  ...
  language: "Idioma",
  languageMenu: "Idioma",
  mercatorSize: "Tamaño Mercator",
  mercatorShort: "Mercator",
  mercatorMenu: "Cuándo mostrar el tamaño Mercator",
  compareAlways: "Siempre",
  compareHover: "Al señalar",
  compareTap: "Al pulsar",
  ...
  searchEmpty: "Ningún lugar coincide con “{query}”",
  layers: "Capas",
...
const FR: AtlasMessages = {
  ...
  language: "Langue",
  languageMenu: "Langue",
  mercatorSize: "Taille Mercator",
  mercatorShort: "Mercator",
  mercatorMenu: "Quand afficher la taille Mercator",
  compareAlways: "Toujours",
  compareHover: "Au survol",
  compareTap: "Au toucher",
  ...
  searchEmpty: "Aucun lieu ne correspond à « {query} »",
  layers: "Couches",
...
const PT: AtlasMessages = {
  ...
  skipToSearch: "Ir para a busca",
  brandHome: "Início Equal Earth",
  tagline: "Projeção Equal Earth, não Mercator",
  language: "Idioma",
  languageMenu: "Idioma",
  mercatorSize: "Tamanho Mercator",
  mercatorShort: "Mercator",
  mercatorMenu: "Quando mostrar o tamanho Mercator",
  compareAlways: "Sempre",
  compareHover: "Ao apontar",
  compareTap: "Ao tocar",
  ...
  searchEmpty: "Nenhum lugar corresponde a “{query}”",
  layers: "Camadas",
...
const AR: AtlasMessages = {
  ...
  skipToSearch: "تخطي إلى البحث",
  brandHome: "الصفحة الرئيسية لـ Equal Earth",
  tagline: "مسقط Equal Earth، وليس مركاتور",
  language: "اللغة",
  languageMenu: "اللغة",
  mercatorSize: "حجم مركاتور",
  mercatorShort: "مركاتور",
  mercatorMenu: "متى يُعرض حجم مركاتور",
  compareAlways: "دائماً",
  compareHover: "عند التمرير",
  compareTap: "عند النقر",
  ...
  searchEmpty: "لا أماكن تطابق «{query}»",
  layers: "الطبقات",
  ...
  layerGraticule: "شبكة الإحداثيات",
  about: "حول",
...
const RU: AtlasMessages = {
  ...
  language: "Язык",
  languageMenu: "Язык",
  mercatorSize: "Размер Меркатора",
  mercatorShort: "Меркатор",
  mercatorMenu: "Когда показывать размер Меркатора",
  compareAlways: "Всегда",
  compareHover: "При наведении",
  compareTap: "При нажатии",
  ...
  searchEmpty: "Нет мест по запросу «{query}»",
  layers: "Слои",
