...
const EN: AtlasMessages = {
  ...
  outlineMuted: "Coral stripes are Mercator’s apparent size.",
  outlineScaled: "The stripes are this country scaled to how large it looks on Mercator.",
...
const ES: AtlasMessages = {
  ...
  outlineMuted: "Las franjas coral son el tamaño aparente en Mercator.",
  outlineScaled: "Las franjas son este país a la escala de lo grande que se ve en Mercator.",
...
const FR: AtlasMessages = {
  ...
  versionLabel: "Version",
  outlineMuted: "Les hachures corail sont la taille apparente sur Mercator.",
  outlineScaled: "Les hachures sont ce pays mis à l’échelle de sa taille apparente sur Mercator.",
